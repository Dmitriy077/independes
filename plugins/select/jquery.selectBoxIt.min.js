...
$(document).on('click', '.selectboxit', function() {
            
           if( $(this).siblings('.selectboxit-options').is(':hidden')) {
                $(this).find('.icon').removeClass('icon_after');
           }
           else {
           		$(this).find('.icon').addClass('icon_after');
           }
        
});

$(document).mouseup(function (e) {
    var container = $(".selectboxit");
